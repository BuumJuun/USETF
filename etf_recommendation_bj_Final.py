...
font_path = '/Users/bumjun/Desktop/USETF/nanum-gothic/NanumGothic.ttf'  # 폰트 파일 경로
...
# 수익률 그래프 생성 (데이터 포인트마다 점 추가)
plt.figure(figsize=(8, 4))
for period in periods:
    plt.plot(df_with_returns['YM'], df_with_returns[f'return_{period}m'], marker='o', linestyle='-', label=f'Return {period} months')
plt.xlabel('Year-Month', fontsize=10)
...
세개의 문단으로 간단하게 존댓말로 설명해 주세요. 중요한 건 특정 증권사를 언급하면 안 됩니다.
"""
